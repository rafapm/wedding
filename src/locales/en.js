export default {
  ...
  things: {
    ...
    categories: {
      restaurants: ['Cal Pep for classic tapas in El Born', 'Bar Cañete for a lively Barcelona dinner', 'Bodega Biarritz or La Plata for old-school bites', 'Can Fisher or Pez Vela for seafood by the water'],
      coffee: ['Nomad Coffee for serious coffee', 'Satan’s Coffee Corner for a modern cafe stop', 'Hofmann Pastisseria for pastries', 'Granja M. Viader for churros and hot chocolate'],
      sightseeing: ['Sagrada Familia', 'Park Guell', 'Casa Batllo or La Pedrera', 'Gothic Quarter and El Born walks', 'Montjuic for views and gardens'],
      beaches: ['Bogatell for a calmer city beach', 'Barceloneta for the classic Barcelona beach scene', 'Sitges for an easy coastal day trip'],
      museums: ['Picasso Museum', 'Joan Miro Foundation', 'MNAC on Montjuic', 'Moco Museum for contemporary art'],
      dayTrips: ['Montserrat for mountain views and the monastery', 'Girona for medieval streets and a beautiful old town', 'Sitges for beaches and a relaxed seaside day', 'Costa Brava if you want coves, clear water, and a longer coastal escape'],
    },
  },
  dress: {
    title: 'Dress Code',
